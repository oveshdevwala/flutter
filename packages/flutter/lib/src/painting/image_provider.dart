...
class ImageConfiguration {
  ...
  @override
  int get hashCode =>
      Object.hash(bundle, devicePixelRatio, locale, size, platform);
    ...
    final ImageStreamCompleter? completer =
      ...
      () {
        ImageStreamCompleter result = loadImage(
            key, PaintingBinding.instance.instantiateImageCodecWithSize);
...
class ResizeImageKey {
  ...
  const ResizeImageKey._(this._providerCacheKey, this._policy, this._width,
      this._height, this._allowUpscaling);
  ...
  @override
  int get hashCode =>
      Object.hash(_providerCacheKey, _policy, _width, _height, _allowUpscaling);
}
...
class ResizeImage extends ImageProvider<ResizeImageKey> {
  ...
  void _configureErrorListener(
      ImageStreamCompleter completer, ResizeImageKey key) {
    completer
        .addEphemeralErrorListener((Object exception, StackTrace? stackTrace) {
